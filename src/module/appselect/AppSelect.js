                    ...
                    <div class="frame">
                        <div class="left-group">
                            <div class="logo-ofca-logo-name">
                                <div class="logo-ofca-logo"><img class="image" src="img/image.png" /></div>
                                <div class="div">
                        ...
                        <div class="frame-2">
                            ...
                            <div class="right-group-2">
                                <div class="div-wrapper">
                                    <div class="wrapper">
                                        <div class="icon-wrapper">
                                            <div class="icon-chevron-down"><img class="union" src="img/union-4.svg" /></div>
                                        </div>
                                ...
                                <div class="div-wrapper">
                                    <div class="wrapper">
                                        <div class="icon-wrapper">
                                            <div class="icon-chevron-down"><img class="img" src="img/union-5.svg" /></div>
                                        </div>
                                ...
                                <div class="div-wrapper">
                                    <div class="wrapper">
                                        <div class="icon-wrapper">
                                            <div class="icon-chevron-down"><img class="union-2" src="img/union-3.svg" /></div>
                                        </div>
                                ...
                                <div class="frame-4">
                                    <div class="div-wrapper">
                                        <div class="wrapper">
                                            <div class="icon-wrapper">
                                                <div class="icon-chevron-down"><img class="union-3" src="img/image.svg" /></div>
                                            </div>
                                            <div class="text-4">Login</div>
                                        </div>
                                    </div>
                                    <img class="divider-separator" src="img/divider-separator-4.svg" />
                ...
                <div class="body-wrapper">
                    <div class="frame-6">
                            ...
                            <div class="frame-7">
                                ...
                                <div class="div-wrapper">
                                    <div class="wrapper-2">
                                        ...
                                        <img class="icon-chevron-down-2" src="img/chevron-down.svg" />
                                    </div>
                                </div>
                            </div>
                            <div class="module-collapse">
                                <div class="frame-8">
                                    <img class="icon-chevron-down" src="img/chevron-down-thin.svg" />
                        ...
                        <div class="side-column">
                            ...
                            <img class="divider-separator-2" src="img/divider-separator-3.svg" />
                            <div class="frame-10">
                                            ...
                                            <div class="placeholder">
                                                <div class="input-prefix">
                                                    <div class="wrapper-wrapper">
                                                        <div class="img-wrapper"><img class="union-5" src="img/union-2.svg" /></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="right-group-3">
                        <div class="frame-11">
                            <div class="frame-12">
                                ...
                                <img class="divider-separator-3" src="img/divider-separator-2.svg" />
                        ...
                        <img class="image-2" src="img/image-26.png" />
